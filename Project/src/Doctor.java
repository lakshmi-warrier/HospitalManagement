...
public class Doctor implements Serializable{
	 String name,email ,username,password, qualification, specialist, mobilenumber,address;
	    ...
	    Doctor(String name,String email,String username,String password,String qualification,
	    ...
	    static void add_doctor() {
	        ...
	        for (Doctor doctor : doctorList) 
	        {
	            ...
	            Doctor Newdoctor = new Doctor(name, email,username,password, qualification, specialist, mobilenumber,address,id, salary );
	    ...
	    static void edit_doctor() {
	        ...
	        for (Doctor doctor : doctorList) 
	        {
	            ...
	            if (doctor.id == id) 
	            {
	                ...
	                System.out.println("String name,String email,String username,String password,String qualification,String specialist,"
	    ...
	    static void writeData() {
	        try {
	            ...
	            for (Doctor i : doctorList) out.writeObject(i);
	    ...
	    {
	        return "\n{id: " + id + ", name:" + name + ",email: " + email+",username:"+username+",password:"+password+", qualification: " + qualification 
	                  
	                + ",specialist:"+specialist+",mobilenumber:"+mobilenumber+",address:"+address+", salary: " + salary + "}";
	    }
	...
	public static void main(String[] args) {
		 ...
		 try {
	            ...
	            doctorList.clear();
	            while (true) {
	                doctorList.add((Doctor) read.readObject());//automatically breaks when it reaches EOF as the exception is caught
	            }
	        } catch (FileNotFoundException e) {
	            System.out.println("File Not Found");
	        } catch (IOException e) {
